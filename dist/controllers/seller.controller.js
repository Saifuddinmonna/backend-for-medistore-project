...
export const sellerAddMedicine = async (req, res, next) => {
    try {
        // pick only the fields we want to allow and validate required ones
        const { name, manufacturer, price, stock, categoryId, description, image } = req.body;
...
export const getSellerMedicines = async (req, res, next) => {
    try {
